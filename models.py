...
class Maestros(db.Model):
    ...
    cursos = db.relationship('Cursos', back_populates='maestro', cascade="all, delete-orphan")
...
class Inscripcion(db.Model):
    ...
    # Restriccion de unicidad para evitar que un alumno se inscriba varias veces en el mismo curso
    __table_args__ = (
